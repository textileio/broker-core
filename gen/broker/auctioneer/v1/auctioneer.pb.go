...
type Auction struct {
	...
	WinningBids     map[string]*Auction_WinningBid `protobuf:"bytes,9,rep,name=winning_bids,json=winningBids,proto3" json:"winning_bids,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
type Auction_WinningBid struct {
	...
	ProposalCidAcknowledged bool   `protobuf:"varint,3,opt,name=proposal_cid_acknowledged,json=proposalCidAcknowledged,proto3" json:"proposal_cid_acknowledged,omitempty"`
}
...
var file_broker_auctioneer_v1_auctioneer_proto_rawDesc = []byte{
	...
	0x0a, 0x0a, 0x07, 0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x51, 0x0a, 0x0c, 0x77, 0x69, 0x6e, 0x6e, 0x69, 0x6e, 0x67, 0x5f, 0x62, 0x69, 0x64, 0x73, 0x18,
	0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x62, 0x72, 0x6f, 0x6b, 0x65, 0x72, 0x2e, 0x61,
	0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x65, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x75, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x57, 0x69, 0x6e, 0x6e, 0x69, 0x6e, 0x67, 0x42, 0x69, 0x64, 0x73,
	0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0b, 0x77, 0x69, 0x6e, 0x6e, 0x69, 0x6e, 0x67, 0x42, 0x69,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x68, 0x0a, 0x10, 0x57, 0x69, 0x6e, 0x6e, 0x69,
	...
	,
	...
	0x70, 0x52, 0x0a, 0x72, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x64, 0x41, 0x74, 0x1a, 0x8f, 0x01,
	0x0a, 0x0a, 0x57, 0x69, 0x6e, 0x6e, 0x69, 0x6e, 0x67, 0x42, 0x69, 0x64, 0x12, 0x22, 0x0a, 0x0c,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c,
	0x43, 0x69, 0x64, 0x12, 0x3a, 0x0a, 0x19, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x5f,
	0x63, 0x69, 0x64, 0x5f, 0x61, 0x63, 0x6b, 0x6e, 0x6f, 0x77, 0x6c, 0x65, 0x64, 0x67, 0x65, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x17, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c,
	0x43, 0x69, 0x64, 0x41, 0x63, 0x6b, 0x6e, 0x6f, 0x77, 0x6c, 0x65, 0x64, 0x67, 0x65, 0x64, 0x22,
	...
	0x54, 0x41, 0x52, 0x54, 0x45, 0x44, 0x10, 0x02, 0x12, 0x10, 0x0a, 0x0c, 0x53, 0x54, 0x41, 0x54,
	0x55, 0x53, 0x5f, 0x45, 0x4e, 0x44, 0x45, 0x44, 0x10, 0x03, 0x12, 0x10, 0x0a, 0x0c, 0x53, 0x54,
	0x41, 0x54, 0x55, 0x53, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x04, 0x22, 0xd1, 0x01, 0x0a,
	0x15, 0x52, 0x65, 0x61, 0x64, 0x79, 0x54, 0x6f, 0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	...
	0x0a, 0x09, 0x64, 0x65, 0x61, 0x6c, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x08, 0x64, 0x65, 0x61, 0x6c, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x64,
	0x65, 0x61, 0x6c, 0x5f, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x64, 0x65, 0x61, 0x6c,
	0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x23, 0x0a, 0x0d, 0x64,
	0x65, 0x61, 0x6c, 0x5f, 0x76, 0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x64, 0x18, 0x05, 0x20, 0x01,
...
var file_broker_auctioneer_v1_auctioneer_proto_depIdxs = []int32{
	...
	1,  // 4: broker.auctioneer.v1.GetAuctionResponse.auction:type_name -> broker.auctioneer.v1.Auction
	10, // 5: broker.auctioneer.v1.Auction.BidsEntry.value:type_name -> broker.auctioneer.v1.Auction.Bid
	11, // 6: broker.auctioneer.v1.Auction.WinningBidsEntry.value:type_name -> broker.auctioneer.v1.Auction.WinningBid
	12, // 7: broker.auctioneer.v1.Auction.Bid.received_at:type_name -> google.protobuf.Timestamp
	2,  // 8: broker.auctioneer.v1.APIService.ReadyToAuction:input_type -> broker.auctioneer.v1.ReadyToAuctionRequest
	4,  // 9: broker.auctioneer.v1.APIService.GetAuction:input_type -> broker.auctioneer.v1.GetAuctionRequest
	6,  // 10: broker.auctioneer.v1.APIService.ProposalAccepted:input_type -> broker.auctioneer.v1.ProposalAcceptedRequest
	3,  // 11: broker.auctioneer.v1.APIService.ReadyToAuction:output_type -> broker.auctioneer.v1.ReadyToAuctionResponse
	5,  // 12: broker.auctioneer.v1.APIService.GetAuction:output_type -> broker.auctioneer.v1.GetAuctionResponse
	7,  // 13: broker.auctioneer.v1.APIService.ProposalAccepted:output_type -> broker.auctioneer.v1.ProposalAcceptedResponse
