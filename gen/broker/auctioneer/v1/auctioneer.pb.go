...
func (x *ProposalAcceptedRequest) GetMiner() string {
	if x != nil {
		return x.Miner
	}
	return ""
...
func (x *Auction_Bid) Reset() {
	*x = Auction_Bid{}
	if protoimpl.UnsafeEnabled {
		mi := &file_broker_auctioneer_v1_auctioneer_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
=======
	...
	0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x52, 0x0a, 0x17, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73,
	...
	0x73, 0x61, 0x6c, 0x5f, 0x63, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x70,
...
>>>>>>> 6779465... proto&gen: new apis fro proposal-cid passthrough
}
...
var file_broker_auctioneer_v1_auctioneer_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_broker_auctioneer_v1_auctioneer_proto_goTypes = []interface{}{
	...
	(*Auction_Bid)(nil),              // 9: broker.auctioneer.v1.Auction.Bid
...
var file_broker_auctioneer_v1_auctioneer_proto_depIdxs = []int32{
	...
	10, // 2: broker.auctioneer.v1.Auction.started_at:type_name -> google.protobuf.Timestamp
	1,  // 3: broker.auctioneer.v1.GetAuctionResponse.auction:type_name -> broker.auctioneer.v1.Auction
	9,  // 4: broker.auctioneer.v1.Auction.BidsEntry.value:type_name -> broker.auctioneer.v1.Auction.Bid
	10, // 5: broker.auctioneer.v1.Auction.Bid.received_at:type_name -> google.protobuf.Timestamp
	...
	6,  // 8: broker.auctioneer.v1.APIService.ProposalAccepted:input_type -> broker.auctioneer.v1.ProposalAcceptedRequest
	3,  // 9: broker.auctioneer.v1.APIService.ReadyToAuction:output_type -> broker.auctioneer.v1.ReadyToAuctionResponse
	5,  // 10: broker.auctioneer.v1.APIService.GetAuction:output_type -> broker.auctioneer.v1.GetAuctionResponse
	7,  // 11: broker.auctioneer.v1.APIService.ProposalAccepted:output_type -> broker.auctioneer.v1.ProposalAcceptedResponse
...
func file_broker_auctioneer_v1_auctioneer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_broker_auctioneer_v1_auctioneer_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
