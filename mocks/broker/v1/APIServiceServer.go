...
// StorageDealAuctioned provides a mock function with given fields: _a0, _a1
func (_m *APIServiceServer) StorageDealAuctioned(_a0 context.Context, _a1 *broker.StorageDealAuctionedRequest) (*broker.StorageDealAuctionedResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *broker.StorageDealAuctionedResponse
	if rf, ok := ret.Get(0).(func(context.Context, *broker.StorageDealAuctionedRequest) *broker.StorageDealAuctionedResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *broker.StorageDealAuctionedRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
// StorageDealFinalizedDeals provides a mock function with given fields: _a0, _a1
func (_m *APIServiceServer) StorageDealFinalizedDeals(_a0 context.Context, _a1 *broker.StorageDealFinalizedDealsRequest) (*broker.StorageDealFinalizedDealsResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *broker.StorageDealFinalizedDealsResponse
	if rf, ok := ret.Get(0).(func(context.Context, *broker.StorageDealFinalizedDealsRequest) *broker.StorageDealFinalizedDealsResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *broker.StorageDealFinalizedDealsRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
