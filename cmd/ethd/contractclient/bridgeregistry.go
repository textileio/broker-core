...
const BridgeRegistryABI = "[{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"provider\",\"type\":\"address\"}],\"name\":\"AddProvider\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"provider\",\"type\":\"address\"}],\"name\":\"DelProvider\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"previousOwner\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"OwnershipTransferred\",\"type\":\"event\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"provider\",\"type\":\"address\"}],\"name\":\"addProvider\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"provider\",\"type\":\"address\"}],\"name\":\"delProvider\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"initialize\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"listProviders\",\"outputs\":[{\"internalType\":\"address[]\",\"name\":\"\",\"type\":\"address[]\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"renounceOwnership\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"transferOwnership\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]"
...
// DelProvider is a paid mutator transaction binding the contract method 0xd5efdd2b.
//
// Solidity: function delProvider(address provider) returns()
func (_BridgeRegistry *BridgeRegistryTransactor) DelProvider(opts *bind.TransactOpts, provider common.Address) (*types.Transaction, error) {
	return _BridgeRegistry.contract.Transact(opts, "delProvider", provider)
}

// DelProvider is a paid mutator transaction binding the contract method 0xd5efdd2b.
//
// Solidity: function delProvider(address provider) returns()
func (_BridgeRegistry *BridgeRegistrySession) DelProvider(provider common.Address) (*types.Transaction, error) {
	return _BridgeRegistry.Contract.DelProvider(&_BridgeRegistry.TransactOpts, provider)
}

// DelProvider is a paid mutator transaction binding the contract method 0xd5efdd2b.
//
// Solidity: function delProvider(address provider) returns()
func (_BridgeRegistry *BridgeRegistryTransactorSession) DelProvider(provider common.Address) (*types.Transaction, error) {
	return _BridgeRegistry.Contract.DelProvider(&_BridgeRegistry.TransactOpts, provider)
}
...
// BridgeRegistryDelProviderIterator is returned from FilterDelProvider and is used to iterate over the raw logs and unpacked data for DelProvider events raised by the BridgeRegistry contract.
type BridgeRegistryDelProviderIterator struct {
	Event *BridgeRegistryDelProvider // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BridgeRegistryDelProviderIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BridgeRegistryDelProvider)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BridgeRegistryDelProviderIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BridgeRegistryDelProviderIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BridgeRegistryDelProvider represents a DelProvider event raised by the BridgeRegistry contract.
type BridgeRegistryDelProvider struct {
	Provider common.Address
	Raw      types.Log // Blockchain specific contextual infos
}

// FilterDelProvider is a free log retrieval operation binding the contract event 0x2fd25cab3c5c708fdf5ffe856e15b9c8f4ac00068d052e044a8e4ed0a6671458.
//
// Solidity: event DelProvider(address indexed provider)
func (_BridgeRegistry *BridgeRegistryFilterer) FilterDelProvider(opts *bind.FilterOpts, provider []common.Address) (*BridgeRegistryDelProviderIterator, error) {
	...
	logs, sub, err := _BridgeRegistry.contract.FilterLogs(opts, "DelProvider", providerRule)
	if err != nil {
		return nil, err
	}
	return &BridgeRegistryDelProviderIterator{contract: _BridgeRegistry.contract, event: "DelProvider", logs: logs, sub: sub}, nil
}

// WatchDelProvider is a free log subscription operation binding the contract event 0x2fd25cab3c5c708fdf5ffe856e15b9c8f4ac00068d052e044a8e4ed0a6671458.
//
// Solidity: event DelProvider(address indexed provider)
func (_BridgeRegistry *BridgeRegistryFilterer) WatchDelProvider(opts *bind.WatchOpts, sink chan<- *BridgeRegistryDelProvider, provider []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _BridgeRegistry.contract.WatchLogs(opts, "DelProvider", providerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BridgeRegistryDelProvider)
				if err := _BridgeRegistry.contract.UnpackLog(event, "DelProvider", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseDelProvider is a log parse operation binding the contract event 0x2fd25cab3c5c708fdf5ffe856e15b9c8f4ac00068d052e044a8e4ed0a6671458.
//
// Solidity: event DelProvider(address indexed provider)
func (_BridgeRegistry *BridgeRegistryFilterer) ParseDelProvider(log types.Log) (*BridgeRegistryDelProvider, error) {
	event := new(BridgeRegistryDelProvider)
	if err := _BridgeRegistry.contract.UnpackLog(event, "DelProvider", log); err != nil {
		return nil, err
	}
