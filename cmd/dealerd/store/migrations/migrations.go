...
func _001_initDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "001_init.down.sql", size: 69, mode: os.FileMode(420), modTime: time.Unix(1627069278, 0)}
...
<<<<<<< HEAD
	info := bindataFileInfo{name: "001_init.up.sql", size: 1300, mode: os.FileMode(420), modTime: time.Unix(1627341929, 0)}
=======
	info := bindataFileInfo{name: "001_init.up.sql", size: 1333, mode: os.FileMode(436), modTime: time.Unix(1627392439, 0)}
