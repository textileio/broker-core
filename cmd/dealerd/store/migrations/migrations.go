...
func _004_batch_id_keyUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "004_batch_id_key.up.sql", size: 3164, mode: os.FileMode(420), modTime: time.Unix(1633562744, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
