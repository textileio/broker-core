...
import (
	...
	"github.com/textileio/broker-core/cmd/chainapis/ethd/releaser"
	"github.com/textileio/broker-core/cmd/chainapis/ethd/service"
...
var flags = []common.Flag{
	...
	{Name: "endpoint-timeout", DefValue: time.Second * 5, Description: "Timeout for initial connection to endpoint-url"},
	{
		...
		Description: "The ETH account id of the governance contract",
	},
	{
		Name:        "client-address",
		DefValue:    "0x580b226185312098376Bf88eea1A86c3bD39DC96",
		Description: "The ETH account id of the user of this client",
	},
	{
