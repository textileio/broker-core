...
const BridgeProviderABI = "[{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"depositee\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"depositor\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"AddDeposit\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"previousOwner\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"OwnershipTransferred\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"depositee\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"depositor\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"ReleaseDeposit\",\"type\":\"event\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"depositee\",\"type\":\"address\"}],\"name\":\"addDeposit\",\"outputs\":[],\"stateMutability\":\"payable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"apiEndpoint\",\"outputs\":[{\"internalType\":\"string\",\"name\":\"\",\"type\":\"string\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"name\":\"deposits\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"timestamp\",\"type\":\"uint256\"},{\"internalType\":\"address\",\"name\":\"depositor\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"value\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"depositee\",\"type\":\"address\"}],\"name\":\"hasDeposit\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"initialize\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"providerProportion\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"depositee\",\"type\":\"address\"}],\"name\":\"releaseDeposit\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"releaseDeposits\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"renounceOwnership\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"sessionDivisor\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"string\",\"name\":\"a\",\"type\":\"string\"}],\"name\":\"setApiEndpoint\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"p\",\"type\":\"uint256\"}],\"name\":\"setProviderProportion\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"m\",\"type\":\"uint256\"}],\"name\":\"setSessionDivisor\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"transferOwnership\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]"
...
func (_BridgeProvider *BridgeProviderCaller) Deposits(opts *bind.CallOpts, arg0 common.Address) (struct {
	...
	outstruct.Depositor = *abi.ConvertType(out[1], new(common.Address)).(*common.Address)
...
func (_BridgeProvider *BridgeProviderCaller) HasDeposit(opts *bind.CallOpts, depositee common.Address) (bool, error) {
	var out []interface{}
	err := _BridgeProvider.contract.Call(opts, &out, "hasDeposit", depositee)
...
func (_BridgeProvider *BridgeProviderSession) HasDeposit(depositee common.Address) (bool, error) {
	return _BridgeProvider.Contract.HasDeposit(&_BridgeProvider.CallOpts, depositee)
}
...
func (_BridgeProvider *BridgeProviderTransactor) AddDeposit(opts *bind.TransactOpts, depositee common.Address) (*types.Transaction, error) {
	return _BridgeProvider.contract.Transact(opts, "addDeposit", depositee)
}
...
func (_BridgeProvider *BridgeProviderSession) AddDeposit(depositee common.Address) (*types.Transaction, error) {
	return _BridgeProvider.Contract.AddDeposit(&_BridgeProvider.TransactOpts, depositee)
}
...
func (_BridgeProvider *BridgeProviderTransactor) ReleaseDeposit(opts *bind.TransactOpts, depositee common.Address) (*types.Transaction, error) {
	return _BridgeProvider.contract.Transact(opts, "releaseDeposit", depositee)
}
...
func (_BridgeProvider *BridgeProviderSession) ReleaseDeposit(depositee common.Address) (*types.Transaction, error) {
	return _BridgeProvider.Contract.ReleaseDeposit(&_BridgeProvider.TransactOpts, depositee)
}
...
func (_BridgeProvider *BridgeProviderTransactor) ReleaseDeposits(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _BridgeProvider.contract.Transact(opts, "releaseDeposits")
}
...
func (_BridgeProvider *BridgeProviderSession) ReleaseDeposits() (*types.Transaction, error) {
	return _BridgeProvider.Contract.ReleaseDeposits(&_BridgeProvider.TransactOpts)
}
...
func (_BridgeProvider *BridgeProviderFilterer) FilterAddDeposit(opts *bind.FilterOpts, depositee []common.Address, depositor []common.Address) (*BridgeProviderAddDepositIterator, error) {
	...
	var depositeeRule []interface{}
	for _, depositeeItem := range depositee {
		depositeeRule = append(depositeeRule, depositeeItem)
	}
	...
	logs, sub, err := _BridgeProvider.contract.FilterLogs(opts, "AddDeposit", depositeeRule, depositorRule)
	if err != nil {
		return nil, err
	}
...
func (_BridgeProvider *BridgeProviderFilterer) WatchAddDeposit(opts *bind.WatchOpts, sink chan<- *BridgeProviderAddDeposit, depositee []common.Address, depositor []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _BridgeProvider.contract.WatchLogs(opts, "AddDeposit", depositeeRule, depositorRule)
	if err != nil {
		return nil, err
	}
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BridgeProviderReleaseDepositIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BridgeProviderReleaseDeposit)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BridgeProviderReleaseDepositIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BridgeProviderReleaseDepositIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_BridgeProvider *BridgeProviderFilterer) FilterReleaseDeposit(opts *bind.FilterOpts, depositee []common.Address, depositor []common.Address) (*BridgeProviderReleaseDepositIterator, error) {
	...
	logs, sub, err := _BridgeProvider.contract.FilterLogs(opts, "ReleaseDeposit", depositeeRule, depositorRule)
	if err != nil {
		return nil, err
	}
	return &BridgeProviderReleaseDepositIterator{contract: _BridgeProvider.contract, event: "ReleaseDeposit", logs: logs, sub: sub}, nil
}
...
func (_BridgeProvider *BridgeProviderFilterer) WatchReleaseDeposit(opts *bind.WatchOpts, sink chan<- *BridgeProviderReleaseDeposit, depositee []common.Address, depositor []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _BridgeProvider.contract.WatchLogs(opts, "ReleaseDeposit", depositeeRule, depositorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BridgeProviderReleaseDeposit)
				if err := _BridgeProvider.contract.UnpackLog(event, "ReleaseDeposit", log); err != nil {
					return err
				}
				event.Raw = log
