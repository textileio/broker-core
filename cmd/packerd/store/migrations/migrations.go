...
<<<<<<< HEAD
	info := bindataFileInfo{name: "001_init.up.sql", size: 984, mode: os.FileMode(420), modTime: time.Unix(1627993740, 0)}
=======
	info := bindataFileInfo{name: "001_init.up.sql", size: 984, mode: os.FileMode(436), modTime: time.Unix(1627648582, 0)}
>>>>>>> d8681d3... packer/broker: persist manifests
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
