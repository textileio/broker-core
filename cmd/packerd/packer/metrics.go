...
func (fc *Packer) initMetrics() {
	...
	fc.metricLastBatchCreated = metrics.Meter.NewInt64ValueObserver(metrics.Prefix+".last_batch_created_epoch", fc.lastCreatedCb)
	fc.metricLastBatchCount = metrics.Meter.NewInt64ValueObserver(metrics.Prefix+".last_batch_count", fc.lastCountCb)
	fc.metricLastBatchSize = metrics.Meter.NewInt64ValueObserver(metrics.Prefix+".last_batch_size", fc.lastSizeCb)
}
